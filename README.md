...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10755&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/concurrent-log-handler-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `concurrent-log-handler` can be installed with:

```
conda install concurrent-log-handler
```

It is possible to list all of the versions of `concurrent-log-handler` available on your platform with:
